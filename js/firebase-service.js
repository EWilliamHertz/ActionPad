...
export const registerUser = async (userData) => {
    ...
    let companyId, finalCompanyName = companyName;
    if (referralId) {
        ...
        } else { throw new Error("Invalid Referral ID. Company not found."); }
    } else {
    ...
    await setDoc(doc(usersCollection, user.uid), { fullName, nickname, email, companyRole, companyId, companyName: finalCompanyName, online: false, last_changed: serverTimestamp() });
    return user;
};
